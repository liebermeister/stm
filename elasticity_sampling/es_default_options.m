...
% es_options.KA_mean     mean values for alpha_A
% es_options.KA_std      std dev values for alpha_A
% es_options.KI_mean     mean values for alpha_I
% es_options.KI_std      std dev values for alpha_I
% es_options.KM_mean     mean values for alpha_M
% es_options.KM_std      std dev values for alpha_M
...
es_constraints.mu0_fix     = nan * ones(nr,1);
es_constraints.mu0_min     = nan * ones(nr,1);
es_constraints.mu0_max     = nan * ones(nr,1);
...
es_options.alpha_A_mean         = [];
es_options.alpha_A_std          = [];   
es_options.alpha_I_mean         = [];
es_options.alpha_I_std          = [];
es_options.alpha_M_mean         = []; 
es_options.alpha_M_std          = [];
