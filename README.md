...
The E. coli central metabolism model, which serves as a running example in the article, can be found in the folder ``[resource-data/models-article/Escherichia_coli_ccm/]``.
