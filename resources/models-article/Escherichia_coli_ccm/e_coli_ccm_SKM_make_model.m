...
%    (uses balanced kinetic constants generated by e_coli_ccm_SKM_balance_parameters.m)
...
mydir           = [stm_code_basedir filesep 'model_e_coli_ccm' filesep];
state_data_file = [mydir 'original_model/e_coli_noor_2016_state_data_modified.tsv'];

%% use balanced kinetic constants generated by e_coli_ccm_SKM_balance_parameters.m
...
model_state_file_out   = [mydir 'model/e_coli_ccm_SKM_ModelState.tsv'];
model_state_file_mat   = [mydir 'model/e_coli_ccm_SKM.mat'];
graphics_file          = [mydir 'model/e_coli_ccm_SKM.jpg'];
...
file_options.prior_file           = [stm_code_basedir '/resources/cmb_prior.tsv'];
...
% kofaktoren (rein-raus) sind schon richtig positioniert
