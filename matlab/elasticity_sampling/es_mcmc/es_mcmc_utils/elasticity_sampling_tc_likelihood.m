function likelihood = elasticity_sampling_ts_likelihood(result,p)

% likelihood = elasticity_sampling_ts_likelihood(result,p)
%
% Likelihood function for concentration time series
